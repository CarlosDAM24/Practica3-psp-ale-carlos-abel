...
public class Terminal {
   ...
   /**
    * Lee un n�mero entero (int) desde el terminal 
    * (dispositivo estandar de entrada). El n�mero 
    * debe finalizar con un salto de l�nea.
    * @param mensaje mensaje que se imprime 
    * @return el valor num�rico leido (como int)
