...
class BancoSA {
  ...
  private static void gestionImposicion() {
    ...
    if (resImp) 
      System.out.println
        ("Operaci�n finalizada correctamente");
    else
      System.out.println
        ("Operaci�n finalizada err�neamente");
  }
  ...
  private static void gestionReintegro() {
    ...
    try{
        ...
        System.out.print("Ha finalizado correctamente la operaci�n de ");
    }
    catch (ESaldoNoValido excep){
        System.out.println(excep.getMessage());
        System.out.print("Ha finalizado err�neamente la operaci�n de ");
    }
